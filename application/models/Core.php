    ...
    <meta property="og:locale" content="id_ID" />';
        ...
        if ($this->uri->segment(2)) {
            ...
            $content = array( 
                ...
                "input_date"  => date('Y-m-d', strtotime(self::select('input_date', 'cms_content', 'presence = 1 and id="' . $this->id_content . '"') ?? '0000-00-00')),
            ...
            $data = array(
                ...
                "pages" =>  $status ?  array(
                    "status" =>  $status,
                    "id" =>  $this->id_pages,
                    "id_pages" =>  self::select('id_pages', 'cms_pages', 'id = "' . $this->id_pages . '" '),
